<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="ALMClient._default" %>
        ...
        <f:RegionPanel ID="RegionPanel1" ShowBorder="false" runat="server">
            <Regions>
                        ...
                        <div id="header">
                            <table>
                                <tr>
                                    <td>
                                        <div class="title">
                                            <a href="./default.aspx">ALM Client</a>
                                        </div>
                                    </td>
                ...
                <f:Region ID="Region2" Split="true" Width="200px" ShowHeader="true" Title="菜单"
                    ...
                    <Items>
                        <f:Tree runat="server" ShowBorder="false" ShowHeader="false" EnableArrows="true"   ID="leftMenuTree">
                            <Nodes>
                                <f:TreeNode Text="默认分类" Expanded="true" NodeID="nodeRoot">
                                    <f:TreeNode Text="缺陷" NavigateUrl="~/Pages/Bugs/BugsList.aspx"></f:TreeNode>
                            ...
                            <table class="bottomtable">
                                <tr>
                                    <%-- <td style="width: 300px;">&nbsp;版本：<a target="_blank" href="http://fineui.com/version">v<asp:Literal runat="server" ID="litVersion"></asp:Literal></a>
                                        &nbsp;&nbsp; <a target="_blank" href="http://fineui.com/qqgroup/">QQ群</a></td>
