<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="TestsList.aspx.cs" Inherits="ALMClient.TestsList" %>
            ...
            <Toolbars>
                <f:Toolbar ID="Toolbar1" runat="server">
                    <Items>
                        ...
                        <f:Button ID="btnNew" runat="server" Icon="Add" EnablePostBack="false" Text="Add New Test">
                        </f:Button>
                    </Items>
                </f:Toolbar>
            </Toolbars>
